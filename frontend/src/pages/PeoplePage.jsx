...
const ZONES = {
    'A': { name: 'โซนหน้าตลาด', area: 'ทางเข้าหลัก อาหารเครื่องดื่ม' },
    'B': { name: 'โซนกลางตลาด', area: 'โซนวัฒนธรรม/กิจกรรม' },
    'C': { name: 'โซนท้ายตลาด', area: 'ท้ายตลาด อาหารเครื่องดื่ม/เสื้อผ้า' }
};
